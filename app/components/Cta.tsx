...
export function Cta() {
  return (
    <div
      id="cta"
      className="w-full mt-3 rounded-[16px] bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]"
    >
      ...
      <div className="mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row lg:justify-center gap-x-[40px]">
        ...
        <button className="flex w-full items-center justify-center font-medium gap-x-3 mt-[32px] text-white lg:w-fit lg:mt-0">
          <Link className="flex items-center justify-center" href="/#pricing">
            Contact Sales
            <span className="ml-2">
